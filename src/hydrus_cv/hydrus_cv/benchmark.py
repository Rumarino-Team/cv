...
def benchmark_calculate_point_3d(
    mock_data: bool,
    detections: list[Detection],
    depth_frame: DepthImage,
    ...
    while True:
        ...
        if not ret or current_frame > frame_limit:
            break
        bench_result = log_performance(
            calculate_point_3d, detections, depth_frame, camera_intrinsic
        )
        result.append(bench_result)
